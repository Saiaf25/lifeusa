...
| DIR-017 | Taproot Plus | Verification not registered | Google returned no exact organization result. Taproot confirms a free nonprofit profile and publicly displays organization logos. On July 24, an authorized nonprofit account was created under Saif Gamal. After the user reported completing verification, a fresh login still redirected to `https://taprootplus.org/verify` and displayed “Verify Your Email to Proceed.” The platform has not registered the verification, so the organization profile, logo, and backlink remain inaccessible | No |
...
| NEW-022 | Taproot Plus | Skilled-volunteer nonprofit profile | Verification not registered | Fresh login still redirects to Taproot's email-verification screen after the user reported completing the verification link |
...
- Taproot still shows “Verify Your Email to Proceed” after a fresh login, so its completed-link state did not register.
