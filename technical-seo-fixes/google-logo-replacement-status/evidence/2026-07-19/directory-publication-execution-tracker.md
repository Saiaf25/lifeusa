...
| DIR-014 | Nextdoor Business | Published, wrong imported image | On July 24, an authorized account was created under Saif Gamal and the logged-out public page was verified at `https://nextdoor.com/pages/life-for-relief-and-development-southfield-mi/`. The page shows the correct legal name, address, phone, public email, description, and canonical HTTPS backlink. However, Nextdoor automatically imported an unrelated storefront awning image instead of the approved LifeUSA logo. The protected editor then blocked automated access, so the wrong image still needs a user-controlled replacement and logged-out verification | No |
...
| DIR-017 | Taproot Plus | Verification completed, profile access pending | Google returned no exact organization result. Taproot confirms a free nonprofit profile and publicly displays organization logos. On July 24, an authorized nonprofit account was created under Saif Gamal, and the user completed the emailed verification step. A later fresh login still opened `https://taprootplus.org/verify`, so profile access may still be synchronizing or may require another platform-side step. The completed verification is preserved as a fact; the organization profile, logo, and backlink remain unverified | No |
...
| DIR-038 | LaCartes | Research candidate | No indexed exact LifeUSA result was found. LaCartes advertises free business registration and public profiles with contact information, photos, and media. The current owner form, logo field, and website-link field still require direct verification | No |
| DIR-039 | 2FindLocal | Research candidate | No indexed exact LifeUSA result was found. The platform advertises free business submission and its public records expose business websites. Logo upload support and the active owner form still require direct verification | No |
| DIR-040 | iBegin | Research candidate | No indexed exact LifeUSA result was found. iBegin exposes a business-submission route and public business profiles. Free status, logo upload support, and website-link support still require direct verification | No |
| DIR-041 | BizHwy | Research candidate | BizHwy advertises free owner-submitted business listings. Its form did not finish loading during the July 24 check, so duplicate status, logo support, and website-link support remain unverified | No |
...
| NEW-013 | Nextdoor Business | Local organization profile | Published, wrong imported image | Logged-out public page has the correct details and canonical HTTPS backlink, but Nextdoor imported an unrelated storefront image instead of the approved logo |
...
| NEW-022 | Taproot Plus | Skilled-volunteer nonprofit profile | Verification completed, profile access pending | User completed the emailed verification step; a later fresh login still opened Taproot's verification screen, so organization-profile access remains unverified |
...
- Taproot verification was completed by the user. A later fresh login still showed “Verify Your Email to Proceed,” so profile access remains pending without invalidating the completed verification step.
- Points of Light account and organization state still require a fresh verified check.
...
- Nextdoor is published with the correct public details and HTTPS backlink, but it currently shows an unrelated storefront image instead of the approved logo.
...
Four additional research candidates were added: LaCartes, 2FindLocal, iBegin, and BizHwy. None counts until its duplicate status, free owner route, approved-logo support, website-link support, and logged-out public result are verified.
